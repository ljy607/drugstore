...
SELECT dbo.T_SPXX.SPBH, dbo.T_SPXX.PM, dbo.T_SPXX.LBBH, dbo.T_SPXX.GG, 
      ...
      dbo.T_JGXX.ZK, dbo.T_SPXX.PZWH, dbo.T_JGXX.hyj,dbo.t_spxx.ypztbh,dbo.t_ypzt.mc as ypztmc,t_spxx.ypfl,t_spxx.jfbz,t_spxx.hxmc,t_splb.SPLB AS splb
...
--if object_id('V_SPXX') is not null
--	drop VIEW V_SPXX
--GO
...
--CASE isnull(T_SPXX.hxmc,'') WHEN '' THEN T_SPXX.pm ELSE T_SPXX.hxmc END AS xspm,t_spxx.spbm AS spbm
